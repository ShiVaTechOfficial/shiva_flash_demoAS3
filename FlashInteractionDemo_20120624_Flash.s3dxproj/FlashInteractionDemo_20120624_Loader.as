...
//-----------------------------------------------------------------------------
{
    ...
    public class FlashInteractionDemo_20120624_Loader extends Sprite  
    //-------------------------------------------------------------------------
    {
		//---------------------------------------------------------------------
		
		[Embed(source="FlashInteractionDemo_20120624_Icon.png")]
		...
		//---------------------------------------------------------------------
		public function FlashInteractionDemo_20120624_Loader ( ) : void 
		{		    
            ...
            loader.load ( new URLRequest ( "FlashInteractionDemo_20120624.swf" ) ) ;
